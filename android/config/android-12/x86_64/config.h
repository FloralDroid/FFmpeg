...
#define FFMPEG_CONFIGURATION "--prefix=/vendor --target-os=android --arch=x86_64 --cpu=x86-64 --enable-cross-compile --disable-x86asm --cc=/tmp/ffmpeg-android12-x86_64-cc --cxx=/tmp/ffmpeg-android12-x86_64-cc --host-cc=/tmp/ffmpeg-android12-x86_64-cc --host-ld=/tmp/ffmpeg-android12-x86_64-cc --ar=/mnt/aosp-hdd/redroid/source/prebuilts/clang/host/linux-x86/clang-r416183b1/bin/llvm-ar --nm=/mnt/aosp-hdd/redroid/source/prebuilts/clang/host/linux-x86/clang-r416183b1/bin/llvm-nm --ranlib=/mnt/aosp-hdd/redroid/source/prebuilts/clang/host/linux-x86/clang-r416183b1/bin/llvm-ranlib --strip=/mnt/aosp-hdd/redroid/source/prebuilts/clang/host/linux-x86/clang-r416183b1/bin/llvm-strip --pkg-config=/tmp/ffmpeg-android12-pkg-config --disable-everything --disable-autodetect --disable-programs --disable-doc --disable-debug --disable-network --disable-avdevice --disable-avfilter --disable-avformat --disable-swresample --disable-swscale --enable-avcodec --enable-avutil --enable-shared --disable-static --enable-pthreads --enable-libdrm --enable-vaapi --enable-decoder=h264,hevc,mpeg2video,vp8,vp9,av1 --enable-encoder=h264_vaapi,hevc_vaapi,mpeg2_vaapi,vp8_vaapi,vp9_vaapi,av1_vaapi --enable-hwaccel=av1_vaapi,h264_vaapi,hevc_vaapi,mpeg2_vaapi,vp8_vaapi,vp9_vaapi --enable-parser=vp9 --enable-bsf=vp9_superframe_split"
#define FFMPEG_LICENSE "LGPL version 2.1 or later"
#define CONFIG_THIS_YEAR 2026
#define FFMPEG_DATADIR "/vendor/share/ffmpeg"
#define AVCONV_DATADIR "/vendor/share/ffmpeg"
#define CC_IDENT "Android (7485623, based on r416183b1) clang version 12.0.7 (https://android.googlesource.com/toolchain/llvm-project c935d99d7cf2016289302412d708641d52d2f7ee)"
